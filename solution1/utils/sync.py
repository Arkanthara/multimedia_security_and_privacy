...
def synchronise_debug(
    ...
    try:
        ...
        axes[2].imshow(img_corrected_crop, cmap="seismic", norm=mcolors.CenteredNorm())
        axes[2].imshow(original[y0:y1, x0:x1], alpha=0.5)
        axes[2].set_title("Step 5c — Corrected crop vs original", fontsize=8)
        for ax in axes: ax.axis("off")
    ...
    try:
        ...
        axes[2].imshow(result, cmap="seismic", norm=mcolors.CenteredNorm())
        axes[2].imshow(original, alpha=0.5)
        axes[2].set_title("Step 8c — Final result vs original", fontsize=8)
        for ax in axes: ax.axis("off")
